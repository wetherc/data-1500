...
DROP DATABASE IF EXISTS dvdrental WITH (FORCE);
...
ALTER TYPE public.mpaa_rating OWNER TO codio;
...
ALTER DOMAIN public.year OWNER TO codio;
...
ALTER FUNCTION public._group_concat(text, text) OWNER TO codio;
...
ALTER FUNCTION public.film_in_stock(
    p_film_id integer,
    p_store_id integer,
    OUT p_film_count integer) OWNER TO codio;
...
ALTER FUNCTION public.film_not_in_stock(
    p_film_id integer,
    p_store_id integer,
    OUT p_film_count integer) OWNER TO codio;
...
ALTER FUNCTION public.get_customer_balance(p_customer_id integer, p_effective_date timestamp without time zone) OWNER TO codio;
...
ALTER FUNCTION public.inventory_held_by_customer(p_inventory_id integer) OWNER TO codio;
...
ALTER FUNCTION public.inventory_in_stock(p_inventory_id integer) OWNER TO codio;
...
ALTER FUNCTION public.last_day(timestamp without time zone) OWNER TO codio;
...
ALTER FUNCTION public.last_updated() OWNER TO codio;
...
ALTER TABLE public.customer_customer_id_seq OWNER TO codio;
...
ALTER TABLE public.customer OWNER TO codio;
...
ALTER FUNCTION public.rewards_report(min_monthly_purchases integer, min_dollar_amount_purchased numeric) OWNER TO codio;
...
ALTER AGGREGATE public.group_concat(text) OWNER TO codio;
...
ALTER TABLE public.actor_actor_id_seq OWNER TO codio;
...
ALTER TABLE public.actor OWNER TO codio;
...
ALTER TABLE public.category_category_id_seq OWNER TO codio;
...
ALTER TABLE public.category OWNER TO codio;
...
ALTER TABLE public.film_film_id_seq OWNER TO codio;
...
ALTER TABLE public.film OWNER TO codio;
...
ALTER TABLE public.film_actor OWNER TO codio;
...
ALTER TABLE public.film_category OWNER TO codio;
...
ALTER TABLE public.actor_info OWNER TO codio;
...
ALTER TABLE public.address_address_id_seq OWNER TO codio;
...
ALTER TABLE public.address OWNER TO codio;
...
ALTER TABLE public.city_city_id_seq OWNER TO codio;
...
ALTER TABLE public.city OWNER TO codio;
...
ALTER TABLE public.country_country_id_seq OWNER TO codio;
...
ALTER TABLE public.country OWNER TO codio;
...
ALTER TABLE public.customer_list OWNER TO codio;
...
ALTER TABLE public.film_list OWNER TO codio;
...
ALTER TABLE public.inventory_inventory_id_seq OWNER TO codio;
...
ALTER TABLE public.inventory OWNER TO codio;
...
ALTER TABLE public.language_language_id_seq OWNER TO codio;
...
ALTER TABLE public.language OWNER TO codio;
...
ALTER TABLE public.nicer_but_slower_film_list OWNER TO codio;
...
ALTER TABLE public.payment_payment_id_seq OWNER TO codio;
...
ALTER TABLE public.payment OWNER TO codio;
...
ALTER TABLE public.rental_rental_id_seq OWNER TO codio;
...
ALTER TABLE public.rental OWNER TO codio;
...
ALTER TABLE public.sales_by_film_category OWNER TO codio;
...
ALTER TABLE public.staff_staff_id_seq OWNER TO codio;
...
ALTER TABLE public.staff OWNER TO codio;
...
ALTER TABLE public.store_store_id_seq OWNER TO codio;
...
ALTER TABLE public.store OWNER TO codio;
...
ALTER TABLE public.sales_by_store OWNER TO codio;
...
ALTER TABLE public.staff_list OWNER TO codio;
...
\.
COPY public.actor (actor_id, first_name, last_name, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3057.dat';
...
\.
COPY public.address (address_id, address, address2, district, city_id, postal_code, phone, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3065.dat';
...
\.
COPY public.category (category_id, name, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3059.dat';
...
\.
COPY public.city (city_id, city, country_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3067.dat';
...
\.
COPY public.country (country_id, country, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3069.dat';
...
\.
COPY public.customer (customer_id, store_id, first_name, last_name, email, address_id, activebool, create_date, last_update, active) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3055.dat';
...
\.
COPY public.film (film_id, title, description, release_year, language_id, rental_duration, rental_rate, length, replacement_cost, rating, last_update, special_features, fulltext) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3061.dat';
...
\.
COPY public.film_actor (actor_id, film_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3062.dat';
...
\.
COPY public.film_category (film_id, category_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3063.dat';
...
\.
COPY public.inventory (inventory_id, film_id, store_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3071.dat';
...
\.
COPY public.language (language_id, name, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3073.dat';
...
\.
COPY public.payment (payment_id, customer_id, staff_id, rental_id, amount, payment_date) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3075.dat';
...
\.
COPY public.rental (rental_id, rental_date, inventory_id, customer_id, return_date, staff_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3077.dat';
...
\.
COPY public.staff (staff_id, first_name, last_name, address_id, email, store_id, active, username, password, last_update, picture) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3079.dat';
...
\.
COPY public.store (store_id, manager_staff_id, address_id, last_update) FROM '/home/codio/workspace/data-1500/data/dvdrentals/3081.dat';
